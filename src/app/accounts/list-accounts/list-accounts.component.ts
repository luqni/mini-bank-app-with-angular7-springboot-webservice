...
export class ListAccountsComponent implements OnInit {
  ...
  constructor(private accountService:AccountsService, private formBuilder:FormBuilder, private activatedRoute:ActivatedRoute) { }
  ...
  submitData(id){
    ...
    accounts.id = this.accountsFormGroup.controls['id'].value;
    accounts.customerid = this.accountsFormGroup.controls['customerid'].value;
